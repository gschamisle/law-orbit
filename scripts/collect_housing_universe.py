"""Collect a separate housing corpus and publish validated evidence only."""
import argparse
...
from core.housing_collection import discover_inventory, collect_sources, prepare_source
from core.housing_universe import BUNDLE, build_graph, report, validate_bundle
...
def main():
    ...
    try:
        ...
        print('국토·건축·주택 수집 실패 · 기존 자료 유지 · '+reason,flush=True)
