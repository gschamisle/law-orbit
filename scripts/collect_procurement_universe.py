"""Collect a separate procurement corpus and publish validated evidence only."""
import argparse
...
from core.procurement_collection import discover_inventory, collect_sources, prepare_source
from core.procurement_universe import BUNDLE, build_graph, report, validate_bundle
...
def main():
    ...
    try:
        ...
        print('조달·계약 수집 실패 · 기존 자료 유지 · '+reason,flush=True)
