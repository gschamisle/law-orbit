...
**2026-09-22 작업판:** 금융 다음에 **공정거래**를 추가해 총 12개 분야를 탐색합니다. 공정위 법령·규정 175건을 수집하고, 조문형 규정과 문단형 심사지침의 명시적 인용을 구분해 연결했습니다. **공정거래는 현재 로컬 미리보기이며 공개 배포 전입니다.** [수집·검증·실행 안내](docs/ftc-universe.md).

[공유용 앱 소개문](docs/app-introduction.md) · [공개 범위와 개발 현황](docs/mofe-universes.md)
...
| 6 | **공공기관** | 운영법과 계약·회계·사업관리 규정의 근거 확인; 현행 평가편람·기관 내규 미분석 | [판단·수집 범위](docs/mofe-universes.md) |
...
| 9 | **공정거래** (로컬 작업판) | 경쟁·기업결합, 기업집단, 하도급, 가맹·유통·대리점, 소비자·약관, 조사·사건절차 | [수집·분석 안내](docs/ftc-universe.md) |
...
- **`main`**: 현재 공개된 11개 분야의 법령 탐색 + 국세 개정안 검토 화면.
